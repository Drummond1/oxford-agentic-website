...
| 7b | Replace Shrestha Mullick's quote with the one she offered to write | Hers is the weakest of the four: it praises the event's success rather than naming an outcome, which is what the other three do. She **agreed on 30 Jul** to write a proper testimonial and was blocked by an assessment that ended **11 Aug**, so she has been free to write it for a week. This is a chase, not an ask | 1 email |
