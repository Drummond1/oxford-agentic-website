...
| 7 | 🔴 **Fei Gan's quote is LIVE and she has not been asked. Ask her, and get her job title** | **Shipped 17 Aug (cycle 81) on Drummond's explicit instruction, caveats accepted.** `src/content/testimonials/fei-gan.md` is on the Cohort 2 page and `/testimonials/`. She gave it willingly, unprompted, in writing — but has not seen the page or agreed the attribution, and `role` reads "Cohort 1 attendee" because the vault has never held her job title. Two things close this: tell her it is up and check she is happy, and get a title to replace the placeholder. If she objects, `consentGiven: false` removes it cleanly | 1 email |
