...
capsule: >-
  ...
  around the numbers rather than the numbers themselves: drafting commentary, triaging
  reconciliations, assembling board packs, first-pass contract review. The judgement,
  the sign-off and the controls stay with the team. The machine removes the assembly,
...
Finance is one of the better places to apply agentic workflows, and one of the easier places to apply them badly. The distinction is worth getting right before you build anything.

## The work that suits it

The pattern that works is repeated, evidence-heavy, and ends in something a human signs off. That describes a lot of a finance month:
...
The step people find hard is not understanding this, it is building the first one. That is the point of a day at the [Oxford Agentic Bootcamp](/bootcamps/oxford-agentic-bootcamp/): you bring one real task from your own work, build a workflow against it, and leave with it running. No coding, and the judgement stays where it belongs.
