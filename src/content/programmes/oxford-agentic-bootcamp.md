---
name: The Oxford Agentic Bootcamp
...
capsule: >-
  The Oxford Agentic Bootcamp is a one-day, in-person bootcamp in Oxford for business
  leaders. Attendees bring one real task from their own work and leave having built a
  working agentic AI workflow against it, so the routine runs itself and the hours go
...
faqs:
  ...
  - q: How do I justify this to my manager?
    a: >-
      ...
      without help. Pricing sits on each event's booking page, so the numbers are easy
      to attach.
  - q: Can I bring my team, or book for several people?
    a: >-
      ...
      the same task so the same workflow goes back to work with both of you. Email
...
You leave with the thing running, and with the pattern, which is the part that transfers.
